...
sub weekday_name {
  ...
  $day += 0;
  my @days = (
    ["понедельник","Понедельник","понедельник","пн."],
    ["вторник","Вторник","вторник","вт."],
    ["среда","Среда","среду","ср."],
    ["четверг","Четверг","четверг","чт."],
    ["пятница","Пятница","пятницу","пт."],
    ["суббота","Суббота","субботу","сб."],
    ["воскресенье","Воскресенье","воскресенье","вс."]
  );
  if($day==0){
    return $days[6][$case];
  }elsif ($day>0 && $day<=7) {
...
sub month_name {
  ...
  $month += 0;
  my @months = (
    ["январь","января","Январь","Января"],
    ["февраль","февраля","Февраль","Февраля"],
    ["март","марта","Март","Марта"],
    ["апрель","апреля","Апрель","Апреля"],
    ["май","мая","Май","Мая"],
    ["июнь","июня","Июнь","Июня"],
    ["июль","июля","Июль","Июля"],
    ["август","августа","Август","Августа"],
    ["сентябрь","сентября","Сентябрь","Сентября"],
    ["октябрь","октября","Октябрь","Октября"],
    ["ноябрь","ноября","Ноябрь","Ноября"],
    ["декабрь","декабря","Декабрь","Декабря"]
  );
  if ($month>0 && $month<=12) {
