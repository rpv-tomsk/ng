...
sub print {
    ...
    if ($self->{_structure}) {
        ...
        #Допустимы следующие ключи в элементах массива:
        # {HEADER  => 'string' }    - строка-заголовок
        # {FIELD   => 'field1'},    - одно поле в строке
        # {FIELDS  => ['field1','field2','field3']} - упрощенная запись перечисления полей, каждое поле в одной строке (NOT IMPLEMENTED!!!)
